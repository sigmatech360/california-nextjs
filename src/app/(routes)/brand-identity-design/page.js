...
import BrandIdentityDesign from '@/src/Screen/InnerChildPages/BrandIdentityDesign';
...
export const metadata = {
  ...
  alternates: {
    canonical: "https://californiawebcoders.com/blockchain-development",
  },
};

export default function BrandIdentityDesignPage() {
  return <BrandIdentityDesign />;
}
